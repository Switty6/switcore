...
('ems.hospital_x',            '298.8',   'Coord X spital spawn (exterior Pillbox - fara MLO nu exista interior)'),
('ems.hospital_y',            '-584.9',  'Coord Y spital spawn'),
('ems.hospital_z',            '43.3',    'Coord Z spital spawn'),
('ems.hospital_heading',      '75.0',    'Heading spawn spital'),
